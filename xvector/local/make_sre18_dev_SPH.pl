...
open(KEY, "<$db_base/docs/sre18_dev_trial_key_SPH.tsv") || die "Could not open trials file $db_base/docs/sre18_dev_trial_key_SPH.tsv.  It might be located somewhere else in your distribution.";
open(SEG_KEY, "<$db_base/docs/sre18_dev_segment_key_SPH.tsv") || die "Could not open trials file $db_base/docs/sre18_dev_segment_key_SPH.tsv.  It might be located somewhere else in your distribution.";
