...
# uses - local/make_sre18_dev_speedup.pl /common_space_docker/storage_2/corpora5/SRE18/SRE18_dev_SPH/ data 09
...
# Handle enroll
$out_dir_enroll = "$out_dir/sre18_dev_enroll_SP$speedup";   # Create data/sre18_dev_enroll_SP09 folder
...
open(META, "<$db_base/docs/sre18_dev_enrollment_SPH.tsv") or die "cannot open wav list - $db_base/docs/sre18_dev_enrollment_SPH.tsv , $out_dir_enroll ";
%utt2fixedutt = ();
while (<META>) {
  $line = $_;
  @toks = split(" ", $line);
...
# Handle test
$out_dir_test= "$out_dir/sre18_dev_test_SP$speedup";
...
open(KEY, "<$db_base/docs/sre18_dev_trials_SPH.tsv") || die "Could not open trials file $db_base/docs/sre18_dev_trials_SPH.tsv.  It might be located somewhere else in your distribution.";
