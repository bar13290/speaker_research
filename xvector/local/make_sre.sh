...
local/make_sre.pl $data_root/SRE04/LDC2006S44/ \
   04 $sre_ref $data_dir/sre2004

local/make_sre.pl $data_root/SRE05/train/LDC2011S01 \
  05 $sre_ref $data_dir/sre2005_train

local/make_sre.pl $data_root/SRE05/test/LDC2011S04 \
  05 $sre_ref $data_dir/sre2005_test

local/make_sre.pl $data_root/SRE06/train/LDC2011S09 \
  06 $sre_ref $data_dir/sre2006_train

local/make_sre.pl $data_root/SRE06/test/LDC2011S10 \
  06 $sre_ref $data_dir/sre2006_test_1

local/make_sre.pl $data_root/SRE06/test/LDC2012S01 \
