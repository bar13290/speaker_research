...
if [ $stage -eq 5 ]; then
  ...
  tdnnf-layer name=tdnnf5 $tdnnf_opts dim=1024 bottleneck-dim=256 time-stride=0
  ...
  tdnnf-layer name=tdnnf9 $tdnnf_opts dim=1024 bottleneck-dim=256 time-stride=0
