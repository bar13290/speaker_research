...
if [ $stage -eq 5 ]; then
  ...
  relu-batchnorm-layer name=tdnn9 input=Append(-5,0,5) dim=512
  relu-batchnorm-layer name=tdnn10 dim=512
  relu-batchnorm-layer name=tdnn11 dim=512
  relu-batchnorm-layer name=tdnn12 dim=1500
