...
if [ $stage -eq 5 ]; then
  ...
  tdnnf-layer name=tdnnf2 $tdnnf_opts dim=850 bottleneck-dim=215 time-stride=2
  tdnnf-layer name=tdnnf3 $tdnnf_opts dim=850 bottleneck-dim=215 time-stride=0
  tdnnf-layer name=tdnnf4 $tdnnf_opts dim=850 bottleneck-dim=215 time-stride=3
  tdnnf-layer name=tdnnf5 $tdnnf_opts dim=850 input=Append(tdnnf3, tdnnf4) bottleneck-dim=215 time-stride=0
  tdnnf-layer name=tdnnf6 $tdnnf_opts dim=850 bottleneck-dim=215 time-stride=3
  tdnnf-layer name=tdnnf7 $tdnnf_opts dim=850 input=Append(tdnnf2, tdnnf4, tdnnf6) bottleneck-dim=215 time-stride=3
  tdnnf-layer name=tdnnf8 $tdnnf_opts dim=850 bottleneck-dim=215 time-stride=3
  tdnnf-layer name=tdnnf9 $tdnnf_opts dim=850 input=Append(tdnnf3, tdnnf5, tdnnf7)bottleneck-dim=215 time-stride=0
  tdnnf-layer name=tdnnf10 $tdnnf_opts dim=850 bottleneck-dim=215 time-stride=3
  tdnnf-layer name=tdnnf11 $tdnnf_opts dim=850 input=Append(tdnnf6, tdnnf8, tdnnf10)bottleneck-dim=215 time-stride=0
  tdnnf-layer name=tdnnf12 $tdnnf_opts dim=850 bottleneck-dim=215 time-stride=3
  tdnnf-layer name=tdnnf13 $tdnnf_opts dim=850 input=Append(tdnnf7, tdnnf9, tdnnf11)bottleneck-dim=215 time-stride=0
  tdnnf-layer name=tdnnf14 $tdnnf_opts dim=850 bottleneck-dim=215 time-stride=3
  tdnnf-layer name=tdnnf15 $tdnnf_opts dim=850 input=Append(tdnnf10, tdnnf12, tdnnf14)bottleneck-dim=215 time-stride=0
  tdnnf-layer name=tdnnf16 $tdnnf_opts dim=850 bottleneck-dim=215 time-stride=3
  tdnnf-layer name=tdnnf17 $tdnnf_opts dim=850 input=Append(tdnnf11, tdnnf13, tdnnf15)bottleneck-dim=215 time-stride=0
  tdnnf-layer name=tdnnf18 $tdnnf_opts dim=850 bottleneck-dim=215 time-stride=3
  tdnnf-layer name=tdnnf19 $tdnnf_opts dim=850 input=Append(tdnnf14, tdnnf16, tdnnf18)bottleneck-dim=215 time-stride=0
  relu-batchnorm-layer name=tdnn20 $tdnn_opts dim=2000
  ...
  relu-batchnorm-layer name=tdnn21 $tdnn_opts dim=512 input=stats
  # This is where another layer the embedding could be extracted
  # from, but usually the previous one works better.
  relu-batchnorm-layer name=tdnn22 $tdnn_opts dim=512
